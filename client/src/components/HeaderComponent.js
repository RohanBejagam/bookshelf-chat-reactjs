                    ...
                    <div className="container">
                        ...
                        
                        {
                            (this.props.auth.isAuthenticated) && !this.props.auth.userinfo.admin?(
                                <NavItem className="ml-2">
                                    <NavLink className="nav-link text-primary" to="/ChatRoom">
                                    <span className="fa text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="fa fa-lg bi bi-chat-dots-fill" viewBox="0 0 16 16">
                     ...
                     <Nav className="ml-auto" navbar>
                     {
                            (this.props.auth.isAuthenticated)?(
                                ...
                                <NavLink className="nav-link text-primary" to="/profile">
                                     <div className="fa fa-user-circle-o fa-lg"/>
                                </NavLink>
                                </NavItem>
                            ):
                            (<div/>)
                     ...
                     <NavItem>
                        ...
                        <Button outline color="primary" onClick={this.toggleModal}>
                                        ...
                                        <Button outline color="primary" onClick={this.handleLogout} tag={Link} to='/home'>
